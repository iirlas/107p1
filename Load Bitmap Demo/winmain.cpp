...
bool Game_Init(HWND window)
{
    ...
    D3DXIMAGE_INFO info;
    result = D3DXGetImageInfoFromFile( "legotron.bmp", &info);
    if (result != D3D_OK)
        return NULL;
    
    RECT srcRect;
    srcRect.top = info.Height/4;
    srcRect.left = info.Width/4;
    srcRect.right  = srcRect.left + info.Width/4;
    srcRect.bottom = srcRect.top  + info.Height/4;
